  ...
  return (
    <main className='flex flex-col gap-10 sm:gap-20 py-10 sm:py-20'>
      ...
      <div className='flex gap-6 justify-center'>
        {/* buttons */}
        <Link to='/jobs'><Button className='bg-blue-500 hover:bg-blue-600 text-white' size='xl'>Find Jobs</Button></Link>
        <Link to='/post-job'><Button variant='destructive' size='xl'>Post a Job</Button></Link>
      ...
      <section className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        ...
        <Card>
          ...
          <CardContent>
            Post Jobs, manage applications, and find the best candidats.
          </CardContent>
        </Card>
      </section>
